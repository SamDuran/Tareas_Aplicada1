...
{
    public partial class Ejercicio10_4 : Window
    {
        ...
        private void IngresarBTN_Click(object sander, RoutedEventArgs e)
        {
            ...
            poligono.Angulos=Convert.ToInt32(Microsoft.VisualBasic.Interaction.InputBox("Angulo:", "Angulos del poligono", "", 40,10));
